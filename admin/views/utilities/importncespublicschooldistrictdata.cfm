...
<cfoutput>
	<div class="art-block clearfix">
		<div class="art-blockheader">
			<h3 class="t">Import NCES Public School District Data into Database</h3>
		</div>
		<div class="art-blockcontent">
			...
			<cfif not isDefined("FORM.formSubmit")>
				<cfquery name="getSchoolDistrictStates" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
					Select PhysicalState
					From pSchoolDistricts
					Group By PhysicalState
					Order by PhysicalState ASC
				</cfquery>
				<cfset ActiveStates = #ValueList(getSchoolDistrictStates.PhysicalState)#>
