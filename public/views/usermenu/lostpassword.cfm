...
<cfoutput>
	<cfif not isDefined("URL.FormRetry") and not isDefined("URL.Key")>
		...
		<hr>
		<uForm:form action="" method="Post" id="LostPassword" errors="#Session.FormErrors#" errorMessagePlacement="both" commonassetsPath="/plugins/1To1TechLocator/library/uniForm/"
			showCancel="yes" cancelValue="<--- Return to Main Page" cancelName="cancelButton" cancelAction="/index.cfm?1To1TechLocatoraction=public:events.viewavailableevents&Return=True"
