...
<cfif isDefined("URL.Key")>
	...
	<cfif DateDiff("n", ListLast(Variables.DateSentCreated, '='), Now()) LTE 45>
		...
		<cflocation url="/index.cfm?UserRegistrationSuccessfull=true&UserAction=AccountVerified" addtoken="false">
	<cfelse>
		<cflocation url="/index.cfm?UserRegistrationSuccessfull=false&UserAction=AccountVerified" addtoken="false">
	</cfif>
</cfif>
